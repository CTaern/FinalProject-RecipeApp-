...
public class RecipeDetailsActivity extends AppCompatActivity {
    ...
    TextView textView_meal_name, textView_meal_source,
            textView_meal_summary;
    ImageView imageView_meal_image;
    RecyclerView recycler_meal_ingredients, recyclerView_instructions;
    ...
    private void findViews() {
        ...
        recyclerView_instructions = findViewById(R.id.recyclerView_instructions);
    }
    ...
    private final RecipeDetailsListener recipeDetailsListener = new RecipeDetailsListener() {
        ...
        public void didFetch(RecipeDetailsResponse response, String message) {
            ...
            recycler_meal_ingredients.setLayoutManager(
                    new LinearLayoutManager(RecipeDetailsActivity.this,
    ...
    private final InstructionsListener instructionsListener = new InstructionsListener() {
        ...
        public void didFetch(List<InstructionsResponse> response, String message) {
            ...
            recycler_meal_ingredients.setAdapter(instructionsAdapter);
